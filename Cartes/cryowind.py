...
pokemon_image = pygame.image.load("Cryowind.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Cryowind"
pokemon_type = "Glace"
pokemon_pv = 95
attaque_1 = "Tempête Polaire"
atk_1_degats = 45
description = "Desciption : Pokémon glacé et majestueux, Cryowind parcourt les montagnes enneigées. Son souffle glacial peut figer instantanément tout ce qu’il touche."
