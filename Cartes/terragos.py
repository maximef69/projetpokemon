...
pokemon_image = pygame.image.load("Terragos.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Terragos"
pokemon_type = "Sol"
pokemon_pv = 90
attaque_1 = "Frappe Sismique"
atk_1_degats = 50
description = "Desciption : Pokémon ancien, Terragos ressemble à une tortue géante aux pattes rocheuses. Il protège les terres anciennes avec une force titanesque."
