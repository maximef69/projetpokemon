...
pokemon_image = pygame.image.load("Fulgoryx.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Fulgoryx"
pokemon_type = "Électrique/Acier"
pokemon_pv = 90
attaque_1 = "Choc d'Orage"
atk_1_degats = 50
description = "Desciption : Avec son corps d’acier parcouru d’éclairs, Fulgoryx est une machine vivante. Il génère une énergie si intense qu’il peut alimenter des villes entières."
