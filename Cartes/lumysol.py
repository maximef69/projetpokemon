...
pokemon_image = pygame.image.load("Lumysol.jpg")
...
pokemon_pv = 100
attaque_1 = "Éclat Solaire"
atk_1_degats = 50
description = "Desciption : Lumysol, le Pokémon solaire, illumine les ténèbres. Son énergie rayonnante réchauffe les cœurs et chasse les ombres de ses ennemis."
