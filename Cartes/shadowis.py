...
pokemon_image = pygame.image.load("Shadowis.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Shadowis"
pokemon_type = "Feu/Fée"
pokemon_pv = 85
attaque_1 = "Frappe Fantôme"
atk_1_degats = 45
description = "Desciption : Shadowis est un spectre insaisissable, se faufilant entre les ombres. On dit qu’il ne laisse derrière lui que des murmures inquiétants."
