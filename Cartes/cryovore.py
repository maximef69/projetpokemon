...
pokemon_image = pygame.image.load("Cryovore.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Cryovore"
pokemon_type = "Glace/Ténèbres"
pokemon_pv = 85
attaque_1 = "Tempête Obscure"
atk_1_degats = 40
description = "Desciption : Cette créature à l’apparence d’un loup gelé rôde dans les ténèbres glaciales. Son souffle froid est aussi redoutable que ses crocs acérés."
