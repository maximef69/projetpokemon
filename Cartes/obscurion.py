...
pokemon_image = pygame.image.load("Obscurion.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Oscurion"
pokemon_type = "Ténèbres"
pokemon_pv = 90
attaque_1 = "Éclipse Noire"
atk_1_degats = 45
description = "Desciption : Entouré d’un halo d’obscurité, Obscurion erre dans les lieux les plus sombres. On raconte qu’il apparaît seulement sous les nuits sans lune."
