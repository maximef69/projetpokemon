...
pokemon_image = pygame.image.load("Lunargent.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Lunargent"
pokemon_type = "Psy/Fée"
pokemon_pv = 100
attaque_1 = "Rayon Astral"
atk_1_degats = 50
description = "Desciption : Lunargent est un gardien des rêves, voyageant entre les mondes. Sa lumière douce éclaire les cœurs troublés et bannit les cauchemars."
