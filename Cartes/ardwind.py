...
pokemon_image = pygame.image.load("Ardwind.jpg")
...
pokemon_pv = 100
attaque_1 = "Souflle Chaud"
atk_1_degats = 50
description = "Desciption : Ardwind est un grand oiseau dont les ailes enflammées illuminent les cieux nocturnes. On dit que son cri annonce un renouveau pour la terre."
