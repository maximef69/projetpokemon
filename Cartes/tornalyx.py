...
pokemon_image = pygame.image.load("Tornalyx.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Tornalyx"
pokemon_type = "Vol"
pokemon_pv = 100
attaque_1 = "Cyclone Dévastateur"
atk_1_degats = 50
description = "Desciption : Maître des tempêtes, Tornalyx vole au sommet des tornades qu’il crée. Ce Pokémon insaisissable est un véritable fléau pour les terres qu’il traverse."
