...
pokemon_image = pygame.image.load("C:/Users/Max/OneDrive/24-25/ort/td_dev/projets/projet_1/Cartes/Aquariel.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Aquariel"
pokemon_type = "Eau"
pokemon_pv = 85
attaque_1 = "Plongée Dévastatrice"
atk_1_degats = 40
description = "Desciption : Ce Pokémon aquatique est aussi gracieux qu’un dauphin. Il bondit hors de l’eau dans des éclats de lumière, attirant les marins en quête d’aventure."
