...
pokemon_image = pygame.image.load("Chromilex.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Chromilex"
pokemon_type = "Acier"
pokemon_pv = 85
attaque_1 = "Lame d'Acier"
atk_1_degats = 40
description = "Desciption : Chromilex est une entité métallique indestructible. Son corps brille comme un miroir, et il reflète les attaques pour les retourner contre ses ennemis."
