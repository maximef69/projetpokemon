...
pokemon_image = pygame.image.load("Voltaryx.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Voltaryx"
pokemon_type = "Étincelle"
pokemon_pv = 90
attaque_1 = "Foudre Stridente"
atk_1_degats = 40
description = "Desciption : Avec son plumage crépitant d’électricité, Voltaryx domine les cieux orageux. On dit qu’un seul battement d’aile suffit à déclencher des éclairs dans un rayon de plusieurs kilomètres."
