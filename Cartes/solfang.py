...
pokemon_image = pygame.image.load("Solfang.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Solfang"
pokemon_type = "Feu/Acier"
pokemon_pv = 95
attaque_1 = "Griffe Incandescente"
atk_1_degats = 45
description = "Desciption : Mi-lion, mi-météore, Solfang incarne la puissance du soleil. Sa crinière brille d’une lumière éclatante, et son rugissement résonne comme un écho céleste."
