...
pokemon_image = pygame.image.load("Fulgorion.jpg")
pokemon_image = pygame.transform.scale(pokemon_image, (300, 300))  # Redimensionner l'image

# Données de la carte Pokémon
pokemon_nom = "Fulgorion"
pokemon_type = "Electrique"
pokemon_pv = 100
attaque_1 = "Éxplosion de chaleur"
atk_1_degats = 70
description = "Description : Un Pokémon légendaire d’énergie pure. Fulgorion peut générer de l’électricité à partir de son propre corps et foudroyer ses ennemis. "
